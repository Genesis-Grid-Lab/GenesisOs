...
namespace UE {
    ...
    void Window::Init(const WindowProps& props){
	    ...
	    if (!success) {
	      UE_CORE_ERROR("GLFW initialization failed!");
	    } else {
	      UE_CORE_INFO("GLFW initialized successfully.");
	    }
