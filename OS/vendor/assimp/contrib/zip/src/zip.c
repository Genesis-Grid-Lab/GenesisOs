...
#define _GNU_SOURCE     // for CLOCK_MONOTONIC, etc.
//#define _POSIX_C_SOURCE 200809L  // for clock_gettime, clockid_t, symlink
#define _XOPEN_SOURCE 700        // for symlink, S_ISSOCK, etc.
...
#include <sys/stat.h>    // for S_IFMT, S_IFDIR, etc.
#include <fcntl.h>       // for file access mode macros
